...
function Dashboard() {
  ...
  const VITE_FRONTEND_URL = "https://nexus1802.netlify.app"; // Toggle dropdown

  const toggleDropdown = () => setIsDropdownOpen((prev) => !prev); // Toggle mobile menu
  ...
  useEffect(() => {
    ...
    const storedEmail = localStorage.getItem("email") || "email@example.com"; // ✅ Email load किया
              ...
              {roomList.length === 0 ? (
                ...
                <ul className="list-disc pl-5 space-y-4">
                  ...
                  {roomList.map((room, index) => {
                    const roomURL = `${VITE_FRONTEND_URL}/room/${encodeURIComponent(
                      room.name
                    )}`;
          ...
          <>
            ...
            <div className="bg-slate-200 shadow-lg p-6 rounded-md flex flex-col gap-7">
              ...
              <p className=" font-normal">
                You don't have any meetings yet or couldn't find meetings you're
                searching for!
              </p>{" "}
            </div>{" "}
          </>
          ...
          <>
            ...
            <div className="shadow-lg lg:mt-[10px] lg:p-6 py-4 lg:w-1/2 rounded-md bg-slate-200 mt-[-60px] flex flex-col text-center lg:text-start gap-5">
              ...
              <div className="flex items-center justify-center lg:justify-start">
                {" "}
                <h2 className="text-green-500 bg-white text-center rounded-full px-6 py-4 text-4xl font-bold ">
  ...
  const MenuItems = (
    <>
      ...
      <div
        className="flex items-center gap-7 cursor-pointer p-2 hover:bg-gray-100 rounded-md"
        onClick={toggleDropdown}
      >
        <RiVideoAddFill /> <p className="m-0">Video Conference</p>{" "}
