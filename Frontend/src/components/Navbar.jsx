...
// function Navbar() {
//   return (
//     <nav className='fixed top-7 left-14 z-50 flex justify-between items-center w-[90vw]'>
//       <div className='leftcorner text-3xl'>Chroma<span className='text-xl'>meet</span></div>
//       <div>
//         <ul className='flex space-x-7'>
//           <li><Link to="/"><a>Home</a></Link></li>
//           <li><Link to="/analytics"><a>Analytics</a></Link></li>
//           <li><Link to="/pricing"><a>Pricing</a></Link></li>
//         </ul>
//       </div>
//       <Link to="/dashboard">
//       <button className="border border-[#E4E4E4] rounded-[7px] bg-white p-[9px] shadow-[0px_-4px_0px_0px_rgba(242,242,242,0.92)_inset,0px_1px_2px_0px_rgba(255,255,255,0.05),0px_-2px_0px_0px_rgba(255,255,255,0.25)_inset] text-[##1E1E1E] font-medium -tracking-[0.12px]">Dashboard</button>
//       </Link>
//     </nav>
//   )
// }
...
function Navbar() {
 ...
 const [menuOpen, setMenuOpen] = useState(false);
  ...
  return (
    <nav className="fixed md:top-10 md:px-5 top-3 px-2 w-full z-50 ">
      <div className=" mx-auto flex justify-between items-center px-6 py-4">
        ...
        {/* Nav Links */}
        <ul className="hidden md:flex items-center space-x-7 text-lg font-medium">
